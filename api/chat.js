/* ============================================================
   ...
   Uses Google Gemini 2.0 Flash (FREE — 1,500 requests/day).
   Server pre-searches Quran API automatically, feeds real
   results to the AI. AI never guesses verse text.
   
   Get FREE API key at: https://aistudio.google.com/apikey
   Set GEMINI_API_KEY in Vercel env variables.
   
   Fallback: GROQ_API_KEY (also free, less accurate)
   ============================================================ */
...
// ============================================================
// QURAN API — server-side automatic search
// ============================================================
...
module.exports = async (req, res) => {
    ...
    try {
        ...
        if (!process.env.GEMINI_API_KEY && !process.env.GROQ_API_KEY) {
            return res.status(500).json({ error: 'AI not configured. Set GEMINI_API_KEY (free — get it at aistudio.google.com/apikey) or GROQ_API_KEY in Vercel env variables.' });
        }
        ...
        if (!reply) return res.status(500).json({ error: 'AI service unavailable. Please try again.' });
